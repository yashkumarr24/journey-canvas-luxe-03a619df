    ...
    >
      ...
      <div className="sticky top-0 h-[100svh] w-full overflow-hidden bg-[oklch(0.14_0.01_260)] [transform:translateZ(0)] [backface-visibility:hidden]">
        ...
        <motion.div
          ...
          className="relative z-10 flex h-full w-full items-end justify-center px-5 pb-[clamp(4.5rem,11svh,8rem)] pt-28 sm:px-6 lg:items-center lg:pb-12 lg:pt-[max(13rem,18vh)] [@media_(min-width:1024px)_and_(max-height:720px)]:items-start [@media_(min-width:1024px)_and_(max-height:720px)]:pb-8 [@media_(min-width:1024px)_and_(max-height:720px)]:pt-36 will-change-transform"
        >
          <motion.div
